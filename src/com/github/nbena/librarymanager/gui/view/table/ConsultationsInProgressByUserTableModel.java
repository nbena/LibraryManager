...
public class ConsultationsInProgressByUserTableModel extends AbstractTableModel
	implements SelectableItem {

	private List<Consultation> items;
	private static final String[] columns = { "Titolo", "Autori" };
	
	public ConsultationsInProgressByUserTableModel(List<Consultation> items){
		this.items = items;
	}
